...
def fix_encoding(content):
    # Fix corrupted warning symbol: c3 a2 c5 a1 c2 a0 e2 9a a0 -> e2 9a a0 (warning)
    content = content.replace(b'\xc3\xa2\xc5\xa1\xc2\xa0\xe2\x9a\xa0', b'\xe2\x9a\xa0')
    
    # Fix corrupted warning symbol: c3 a2 c5 a1 c2 a0 -> e2 9a a0 (warning)
    content = content.replace(b'\xc3\xa2\xc5\xa1\xc2\xa0', b'\xe2\x9a\xa0')
