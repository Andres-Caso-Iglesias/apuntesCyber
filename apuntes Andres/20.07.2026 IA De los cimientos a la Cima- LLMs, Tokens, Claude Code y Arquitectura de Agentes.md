...
| **GPT-4o** | ⭐⭐⭐⭐ Bien, algo repetitivo | ✓ Buena | │š ï¸ Precios genéricos | Markdown | ~12s |
| **Gemini 1.5 Pro** | ⭐⭐⭐ Correcto | │š ï¸ Faltan algunas cantidades | ”Œ No precios | Markdown | ~20s |
| **Copilot (GPT-4o)** | ⭐⭐⭐ Similar a GPT-4o | ✓ | │š ï¸ | Markdown | ~15s |
...
```bash
# │š ï¸ PELIGROSO - Solo en entornos controlados / contenedores desechables
