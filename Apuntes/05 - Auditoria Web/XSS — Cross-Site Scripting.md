...
- [[../../apuntes Joselu/MODULO3/resumen_master_clase53.md|resumen_master_clase53]] — Burp Suite, Metodología Pentest, Redes
- [[OWASP API Security Top 10.md|OWASP API Security Top 10]] — FFUF, Redes, SQL Injection
- [[SSTI — Server-Side Template Injection.md|SSTI — Server-Side Template Injection]] — Burp Suite, Redes, SQL Injection
...
- [[../../apuntes Chema/PortSwigger — SSRF y cierre SSTI.md|PortSwigger — SSRF y cierre SSTI]] — Burp Suite, Metodología Pentest, Redes
...
> #burpsuite #ffuf #pentest #redes #sqli #ssrf #ssti #xss
