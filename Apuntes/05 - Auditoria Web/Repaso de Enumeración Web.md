...
> [[Apuntes/05 - Auditoria Web/Enumeración Web]] Â· [[Fuzzing Web con ffuf]] Â· [[Burp Suite - Framework de Auditoría]] Â· [[Nmap - Escaneo y Enumeración]]
> →’

---

## â‘  Anatomía de una URL
...
https://ejemplo.es/directorio?q=valor&page=2
 ...
 â”‚ â”‚ â”‚ â”‚ â””â”€ separador de parámetros: &
 â”‚ â”‚ â”‚ â””â”€ variable (q) = valor
 â”‚ â”‚ â””â”€ directorio / ruta
 â”‚ â””â”€ dominio (.es = España, .com = global, .mx = México...)
...
## â‘£ Fuerza bruta vs Password spraying vs Enumeración de directorios
...
## â‘¤ Rate limit, WAF y cálculo de delays

El **rate limit** es el número máximo de intentos permitidos por unidad de tiempo. Siempre tiene forma de `nÂº de intentos / tiempo`.
...
## â‘¦ Metodología de pentesting y reconocimiento web
...
## â‘§ Caso práctico: máquina Bashed (Hack The Box)
...
## â‘¨ Herramientas utilizadas en la sesión
...
## â‘ª Errores comunes y buenas prácticas
...
> - Calcular **delays** en spraying según nÂº de usuarios para no superar el rate limit

---

## â‘« Conexión con sesiones anteriores
...
- [ ] Sé qué es el rate limit y cómo calcular un delay según el nÂº de usuarios
...
## â‘® Actualización del registro de herramientas
